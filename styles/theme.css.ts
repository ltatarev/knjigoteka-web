...
// The font families come from next/font/google (see app/fonts.ts), which exposes
// each one as a CSS custom property. Gatsby loaded these by literal name via
// @fontsource; the rendered family is the same.
const fonts = {
  text: "var(--font-dm-sans), sans-serif",
